...
from code.Const import COLOR_WHITE, WIN_HEIGHT, MENU_OPTION, EVENT_ENEMY, SPAWN_TIME, EVENT_TIMEOUT, TIMEOUT_STEP, \
    TIMEOUT_LEVEL, COLOR_GREEN, COLOR_CYAN
...
class Level:
    def __init__(self, window, name, game_mode, player_score):
        ...
        self.entity_list.extend(EntityFactory.get_entity(self.name + "Bg"))  # LIST OF THE BACKGROUND IMAGES
    ...
    def run(self, player_score):
        ...
        while True:
            ...
            for ent in self.entity_list:
                ...
                if ent.name == 'Player1':
                    self.level_text(20, f'Player1 - Health: {ent.health} | Score: {ent.score}', COLOR_GREEN, (10, 25))
                if ent.name == 'Player2':
                    self.level_text(20, f'Player2 - Health: {ent.health} | Score: {ent.score}', COLOR_CYAN, (10, 45))
